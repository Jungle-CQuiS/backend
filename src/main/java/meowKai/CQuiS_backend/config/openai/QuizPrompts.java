...
public class QuizPrompts {
    public static final String SHORT_QUIZ_PROMPT =
            """
                    ...
                    퀴즈 카테고리 데이터는 배열 형태로 만들어줘. 만약 해당 문제가 여러 개의 카테고리에 포함될 경우 배열 안에 해당되는 카테고리를 모두 넣어줘.
                    만약에 해당 문제가 OS, 자료구조에 모두 포함된다면 "categoryType": ["OS", "자료구조"] 이런 형태로 배열 안에 포함되는 카테고리를 모두 넣어주면 돼.
